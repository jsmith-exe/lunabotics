...
setup(
    ...
    (os.path.join('share', package_name, 'worlds', 'regolith_model'), glob('worlds/regolith_model/model.config')),
    (os.path.join('share', package_name, 'worlds', 'regolith_model', 'materials', 'scripts'), glob('worlds/regolith_model/materials/scripts/*')),
    (os.path.join('share', package_name, 'worlds', 'regolith_model', 'materials', 'textures'), glob('worlds/regolith_model/materials/textures/*')),
